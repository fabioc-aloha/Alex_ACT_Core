...
- Corrected the shared installation guide to name Enterprise `v1.1.0`.

## [3.1.0] - 2026-08-17

### Added

- Extended `bootstrap-project` with additive portable workspace QoL settings for
  editor, diff, Markdown, file/search, PowerShell terminal, and Git behavior.
  User-profile and extension-specific settings remain outside the bootstrap.
...
- Extended `doc-hygiene` with a tested five-layer code-documentation ladder for
  invariant-focused comments, portable adoption guides, stable technical
  references, changelogs, and decision records.
...
- `risk-analysis`: replaced the retired Edition and Supervisor names in the risk
  category table with Core and Steward. Prose only; the categories and their
...
- Added Stake and Service rows to the always-on Alex Finch personality runtime
  contract, with matching boundaries against deciding what matters for the
  person and against treating a visible discipline marker as the goal.
