...
**Published version**: Core v3.1.2 provides 32 skills, 9 slash-command prompts,
and 16 source instructions. Current unreleased source provides 34 skills, 9
prompts, and the same 16-instruction bootstrap. Core activates
