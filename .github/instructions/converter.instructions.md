...
4. Verify the output exists, is non-empty, and opens in the appropriate viewer
5. Report results with any converter diagnostics

Options differ by converter. Load the format skill or inspect the script's help output before passing flags.
