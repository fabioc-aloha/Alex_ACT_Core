...
If the user's request already includes the note text, skip the "what should I capture?" question and write it directly. Resolve repo root, append checkbox item to `HANDOFF.md`, optionally mirror to shared memory (if configured) with project-specifics stripping, confirm.
